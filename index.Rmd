...
## <i class="fa-solid fa-person-chalkboard"></i> Grades MSc Molecular and Cellular life sciences (MCLS) {data-icon=NULL .page-break-before}
...
## <i class="fa-solid fa-person-chalkboard"></i> Grades BSc in Biology {data-icon=NULL}
